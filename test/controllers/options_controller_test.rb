...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { num_voted: @option.num_voted, poll_id: @option.poll_id, text: @option.text, total_vote: @option.total_vote }
    end
  ...
  test "should update option" do
    patch :update, id: @option, option: { num_voted: @option.num_voted, poll_id: @option.poll_id, text: @option.text, total_vote: @option.total_vote }
    assert_redirected_to option_path(assigns(:option))
  end
